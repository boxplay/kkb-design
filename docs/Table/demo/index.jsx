...
import { Table, ConfigProvider, Modal, Input } from '@base/kkb-design';
import zhCN from 'antd/lib/locale/zh_CN';
import { createFromIconfontCN } from '@ant-design/icons';
import { time, money, avatar, group, name, trueText } from '../../mock/index';
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 10; i += 1) {
      list.push({
        ...
        text: trueText[getRandomNumberByRange(0, trueText.length)] || 1,
        money: money[getRandomNumberByRange(0, money.length)],
        time: time[getRandomNumberByRange(0, time.length)],
